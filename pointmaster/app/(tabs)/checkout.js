...
import { Text, View, SafeAreaView, StyleSheet, Button, TouchableOpacity, FlatList, Image } from 'react-native';
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity style={[styles.button, styles.proceedButton]} onPress={() => alert('Proceed button pressed')}>
                    <Text style={styles.buttonText}>Proceed</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.button, styles.cancelButton]} onPress={() => alert('Cancel button pressed')}>
